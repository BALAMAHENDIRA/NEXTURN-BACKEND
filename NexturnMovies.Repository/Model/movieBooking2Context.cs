...
{
    public partial class movieBooking2Context : DbContext
    {
        public movieBooking2Context()
        {
        }

        public movieBooking2Context(DbContextOptions<movieBooking2Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source =(localdb)\\MSSQLLocalDB;Initial Catalog=movieBooking2; Integrated Security=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Food>(entity =>
            {
                entity.HasKey(e => e.SnackId)
                    .HasName("PK__Foods__320A85EBC73BA37C");
                ...
                entity.HasOne(d => d.Show)
                    .WithMany(p => p.Foods)
                    .HasForeignKey(d => d.ShowId)
                    .HasConstraintName("FK__Foods__ShowID__3A81B327");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Foods)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Foods__UserID__398D8EEE");
            });
            ...
            modelBuilder.Entity<SeatDetail>(entity =>
            {
                entity.HasKey(e => e.SeatDetailsId)
                    .HasName("PK__SeatDeta__C18AD9E9B420CCE1");
